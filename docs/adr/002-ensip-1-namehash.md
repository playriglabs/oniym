...
See [`contracts/src/lib/Namehash.sol`](../../contracts/src/lib/Namehash.sol) and [`sdk/src/namehash.ts`](../../sdk/src/namehash.ts). A parity test ensures Solidity and TypeScript produce identical output.
